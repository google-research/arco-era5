...
def ingest_data_in_zarr_dataflow_job(target_path: str, region: str, start_date: str, end_date: str,
                                     init_date: str, PROJECT: str, BUCKET: str, SDK_CONTAINER_IMAGE: str) -> None:
    """
    ...
    if '/ar/' in target_path:
        file_path = '/usr/local/google/home/dabhis/github_repo/arco-new/arco-era5/src/data_automate/update-ar-data.py'
        ...
        file_path = "/usr/local/google/home/dabhis/github_repo/arco-new/arco-era5/src/data_automate/update-co-data.py"
