...
ar_single_level_chunks = [
    "total_precipitation", "total_column_water_vapour", "total_cloud_cover",
    "toa_incident_solar_radiation", "surface_pressure",
    "sea_surface_temperature", "sea_ice_cover", "mean_sea_level_pressure",
    "2m_temperature", "10m_v_component_of_wind", "10m_u_component_of_wind",
    "volumetric_soil_water_layer_1", "volumetric_soil_water_layer_2",
    "volumetric_soil_water_layer_3", "volumetric_soil_water_layer_4",
    "mean_top_net_long_wave_radiation_flux",
    "mean_top_net_short_wave_radiation_flux", "high_vegetation_cover",
    "ice_temperature_layer_1", "ice_temperature_layer_2",
    "ice_temperature_layer_3", "ice_temperature_layer_4", "lake_cover",
    ...
    "soil_temperature_level_4", "soil_type", "type_of_high_vegetation",
    "type_of_low_vegetation", "100m_u_component_of_wind",
    "100m_v_component_of_wind", "10m_u_component_of_neutral_wind",
    "10m_v_component_of_neutral_wind",
    "10m_wind_gust_since_previous_post_processing",
    "2m_dewpoint_temperature", "air_density_over_the_oceans",
    "angle_of_sub_gridscale_orography",
    "anisotropy_of_sub_gridscale_orography",
    "benjamin_feir_index", "boundary_layer_dissipation",
    "boundary_layer_height", "charnock",
    "clear_sky_direct_solar_radiation_at_surface",
    "cloud_base_height", "coefficient_of_drag_with_waves",
    "convective_available_potential_energy",
    "convective_inhibition", "convective_precipitation",
    "convective_rain_rate", "convective_snowfall",
    ...
    "friction_velocity", "geopotential_at_surface",
    ...
    "lake_bottom_temperature", "lake_shape_factor", "large_scale_precipitation",
    "large_scale_precipitation_fraction", "large_scale_rain_rate",
    "large_scale_snowfall",
    "large_scale_snowfall_rate_water_equivalent", "low_cloud_cover",
    ...
    "mean_evaporation_rate", "mean_gravity_wave_dissipation",
    ...
    "skin_reservoir_content", "slope_of_sub_gridscale_orography",
    ...
    "surface_net_thermal_radiation_clear_sky", "surface_runoff",
    "surface_sensible_heat_flux",
    "surface_solar_radiation_downward_clear_sky",
    "surface_solar_radiation_downwards",
    "surface_thermal_radiation_downward_clear_sky",
    "surface_thermal_radiation_downwards",
    "temperature_of_snow_layer", "top_net_solar_radiation",
    ...
    "trapping_layer_top_height", "u_component_stokes_drift",
...
def process(z_file: str, table: str, init_date: str):
    ...
    if '/ar/' in z_file:
        process_zarr_and_table(z_file, table, dates_data["first_day_first_prev"],
                               dates_data["last_day_first_prev"], init_date)
    else:
        process_zarr_and_table(z_file, table, dates_data["first_day_third_prev"],
