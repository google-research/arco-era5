...
ARCO_ERA5_WITH_MODEL_LEVEL_SDK_CONTAINER_IMAGE = "ARCO_ERA5_WITH_MODEL_LEVEL_SDK_CONTAINER_IMAGE"
...
MODEL_LEVEL_ZARR_EXECUTOR_JOB_ID = "model-level-zarr-executor"
...
MODEL_LEVEL_ZARR_EXECUTOR_JOB_CONTAINER_ARGS = [
    "src/arco_era5/model-level-native-vertical-zarr-monthly-executor.py"
]
...
JOB_CONTAINER_ENV_VARIABLES = [
    ...
    {"name": "ARCO_ERA5_WITH_MODEL_LEVEL_SDK_CONTAINER_IMAGE", "value": ARCO_ERA5_WITH_MODEL_LEVEL_SDK_CONTAINER_IMAGE}
]
